...
identifier_string = "trajOpt_2d_inverse_kinematics"
...
LR_SCHEDULER_MULTIPLICATIVE_REDUCTION = 0.99992
...
def save_model(model, iteration_actual, iteration_outer, iteration_inner, string_path, string_dict_only, string_full):
    ...
    print("Actual {} (Inner {}, Outer {}) Saved Current State for Evaluation.\n".format(iteration_actual, iteration_inner, iteration_outer))
...
save_model(model, nb_actual_iterations, i, j, dir_path_id_model, nn_model_state_dict_only_str, nn_model_full_str)
